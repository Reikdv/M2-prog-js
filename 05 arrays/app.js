class App {
    runApplication() {
        ...
        const list = ["Kanye West", "Louivos","Rarri"];
        console.log(list);
        ...
        list.push("Marco Borsato")
        list.push("Mula B")
        for (let i = 0; i < list.length; i++) {
            const element = i +": " + list[i];
            console.log(element);
        }
        let indexToRemove = list.indexOf("Drake")
        list.splice(indexToRemove,1)
        indexToRemove = list.indexOf("lil Durk")
        list.splice(indexToRemove,1)
        list.push("David bowie")
        list.push("Blueface")
        for (let i = 0; i < list.length; i++) {
            const element = i +": " + list[i];
            console.log(element);
